...
function Admin() { return <section className="page-width simple-page"><p className="eyebrow">ADMINISTRATORA PANELIS</p><h1>Rīku<br /><em>pārvaldība.</em></h1><div className="admin-stats"><div><span>INVENTĀRĀ</span><strong>24</strong><small>instrumenti</small></div><div><span>AKTĪVAS REZERVĀCIJAS</span><strong>08</strong><small>šonedēļ</small></div><div><span>LIETOTĀJI</span><strong>142</strong><small>kopā</small></div></div></section> }
